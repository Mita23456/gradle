...
public class LibrariesSourceGenerator extends AbstractSourceGenerator {
    ...
    private void performValidation(List<String> libraries, List<String> bundles, List<String> versions, List<String> plugins) {
        ...
        if (size > MAX_ENTRIES) {
            throw throwVersionCatalogProblemException(problemService.internalProblemReporter().create(builder ->
    ...
    private void assertUnique(InternalProblems problemService, List<String> names, String prefix, String suffix) {
        List<Problem> errors = names.stream()
            ...
            .map(e -> {
                ...
                return this.problemService.internalProblemReporter().create(builder ->
